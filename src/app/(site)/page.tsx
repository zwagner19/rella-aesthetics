        ...
        <div className="flex items-center px-6 py-20 md:px-8 md:py-24 lg:pl-[max(3rem,calc((100vw-1200px)/2))] lg:pr-16">
          <div className="max-w-[620px]">
            ...
            <p className="mb-9 max-w-[520px] text-lg font-light leading-relaxed text-ink/70">
              Personalized aesthetic and wellness treatments designed around your goals.
              Natural-looking results, elevated care in Vacaville and Napa.
            </p>
        ...
        <div className="mx-auto grid max-w-[1200px] items-center gap-12 px-6 md:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20 lg:px-12">
          ...
          <div className="lg:pl-6">
            ...
            <p className="mb-5 text-lg font-light leading-relaxed text-ink/70">
              Aesthetic care can come with a lot of choices. Rella starts with what you want to
              work on, what you want explained, and how you want the experience to feel.
            </p>
            <p className="mb-8 leading-relaxed text-ink/65">
              From skin care and injectables to wellness services, the goal is a clear
              conversation and a next step shaped around you, not a one-size-fits-all plan.
            </p>
      ...
      <section className="bg-rose py-24 text-ink md:py-32">
        <div className="mx-auto grid max-w-[1200px] items-center gap-12 px-6 md:px-8 lg:grid-cols-2 lg:gap-20 lg:px-12">
          ...
          <div className="lg:pl-8">
            ...
            <Button href="/services/weight-loss" variant="light" disableHover>
