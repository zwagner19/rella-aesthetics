...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The button opens Rella Vacaville's live injectable category. Choose the filler service, professional, and appointment that fit your visit before confirming.",
  },
] as const;
    ...
    <>
        ...
        <div className="mx-auto grid max-w-[1200px] items-center gap-12 px-6 md:px-8 lg:grid-cols-[1.04fr_0.96fr] lg:px-12">
          <div>
            ...
            <p className="mt-5 text-xs leading-6 text-ink/70">
              Opens Rella Vacaville&apos;s live injectable category. No service, professional, or appointment is selected for you.
            </p>
          </div>
          ...
          <div className="relative aspect-square self-center overflow-hidden bg-rose-blush sm:aspect-[4/3]">
            ...
            <div className="absolute inset-x-0 bottom-0 border-t border-white/30 bg-white/94 p-5 md:p-6">
              <p className="mb-2 text-[0.625rem] font-bold uppercase tracking-[0.2em] text-rose-text">Rella Aesthetics — Vacaville</p>
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-filler-pricing">
        <div className="mx-auto max-w-[1120px] px-6 md:px-8">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              <p className="mb-4 text-[0.6875rem] font-bold uppercase tracking-[0.2em] text-rose-text">Current pricing</p>
              <h2 id="vacaville-filler-pricing" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-rose-text md:text-5xl">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <article className="border border-ink/12 bg-white p-7">
                ...
                <h3 className="mb-4 text-xs font-bold uppercase tracking-[0.16em] text-rose-text">Base service amount</h3>
              ...
              <article className="border border-rose bg-rose-blush p-7">
                ...
                <h3 className="mb-4 text-xs font-bold uppercase tracking-[0.16em] text-rose-text">Active product range</h3>
          ...
          <div className="mt-8 flex flex-col items-start justify-between gap-5 border border-ink/12 bg-white p-7 md:flex-row md:items-center md:p-9">
            ...
            <Link href="/membership" className="shrink-0 text-sm font-semibold text-rose-text underline decoration-rose-light underline-offset-4 hover:text-rose-text">
              Compare memberships →
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-filler-visit">
        <div className="mx-auto grid max-w-[1040px] gap-8 px-6 md:px-8 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-4 text-[0.6875rem] font-bold uppercase tracking-[0.2em] text-rose-text">Your visit</p>
            <h2 id="vacaville-filler-visit" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-rose-text md:text-5xl">
          ...
          <div className="border-l-4 border-rose bg-rose-blush p-7 md:p-10">
            <p className="mb-3 text-[0.6875rem] font-bold uppercase tracking-[0.18em] text-rose-text">Plan around recovery</p>
            ...
            <Link href="/services/dermal-fillers" className="text-sm font-semibold text-rose-text underline decoration-rose-light underline-offset-4 hover:text-rose-text">
      ...
      <section className="bg-rose-blush py-20 md:py-24" aria-labelledby="visit-rella-vacaville-filler">
        <div className="mx-auto grid max-w-[1000px] gap-8 px-6 md:grid-cols-[1fr_auto] md:items-center md:px-8">
          <div>
            ...
            <h2 id="visit-rella-vacaville-filler" className="mb-3 text-3xl font-medium tracking-[-0.035em] text-rose-text">
          ...
          <div className="flex flex-col gap-3">
            <Button href={BOOKING_HREF} data-cta="service-booking" disableHover className="rounded-full">Browse Injectable Booking</Button>
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-filler-faq">
        <div className="mx-auto max-w-[900px] px-6 md:px-8">
          ...
          <h2 id="vacaville-filler-faq" className="mb-8 text-3xl font-medium tracking-[-0.035em] text-rose-text md:text-5xl">
