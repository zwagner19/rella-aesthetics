...
export const metadata: Metadata = {
  ...
  description:
    "Compare microneedling pathways at Rella Aesthetics in Vacaville, then book the Initial Microneedling Consult currently available online.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "Microneedling in Vacaville | Rella Aesthetics",
    description:
      "Consult-first Skin Stylus and RF microneedling planning with online booking for the Vacaville initial consultation.",
    url: CANONICAL,
    type: "website",
    images: [
      {
...
const paths = [
  ...
  },
  {
    ...
    body: "A standard microneedling pathway to discuss during the consult. Availability, device settings, treatment area, comfort measures, recovery, and number of procedures require an individual plan.",
  },
  {
    title: "RF Microneedling",
    body: "A separate pathway that combines microneedles with radiofrequency energy. It is not interchangeable with standard microneedling; availability and its different risk profile require a consult.",
  },
] as const;
...
const faqs = [
  {
    ...
    answer:
      "Rella's current Vacaville online microneedling category lists the Initial Microneedling Consult. Skin Stylus, RF microneedling, packages, and add-ons may be discussed with the team, but their availability should not be inferred from the online menu.",
  },
  {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid max-w-[1200px] items-center gap-12 px-6 md:px-8 lg:grid-cols-[1.04fr_0.96fr] lg:px-12">
          <div>
            ...
            <p className="mt-5 text-xs leading-6 text-ink/70">
              This button opens Vacaville&apos;s live microneedling category, which currently lists the Initial Microneedling Consult.
            </p>
          </div>
          ...
          <div className="relative aspect-square self-center overflow-hidden bg-rose-blush sm:aspect-[4/3]">
            <Image
              ...
              alt="A provider performing a microneedling facial treatment for a reclining patient"
              fill
              preload
      ...
      <TrustStrip
        ...
        items={["Initial consult online", "Modality selected later", "Individual recovery plan", "Downtown Vacaville"]}
      />
        ...
        <div className="mx-auto max-w-[1120px] px-6 md:px-8">
          <div className="mb-12 max-w-[790px]">
            <p className="mb-4 text-[0.6875rem] font-bold uppercase tracking-[0.2em] text-rose-text">
              Treatment paths to discuss
            </p>
            <h2 id="vacaville-microneedling-options" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-rose-text md:text-5xl">
              One consult. Two different technologies.
            </h2>
            <p className="text-lg font-light leading-relaxed text-ink/70">
              Skin Stylus and RF microneedling use different technology and carry different considerations. The current online category lists the Initial Microneedling Consult so the team can compare fit and availability first.
            </p>
          </div>
          <div className="grid gap-5 lg:grid-cols-3">
            {paths.map((path, index) => (
              ...
              >
                ...
                <h3 className="mb-4 text-xl font-medium tracking-[-0.02em] text-rose-text">{path.title}</h3>
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-microneedling-rf">
        <div className="mx-auto grid max-w-[1040px] gap-8 px-6 md:px-8 lg:grid-cols-[1.03fr_0.97fr] lg:items-center">
          <div>
            <p className="mb-4 text-[0.6875rem] font-bold uppercase tracking-[0.2em] text-rose-text">RF deserves a separate conversation</p>
            <h2 id="vacaville-microneedling-rf" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-rose-text md:text-5xl">
          ...
          <div className="border-l-4 border-rose bg-rose-blush p-7 md:p-10">
            <p className="mb-3 text-[0.6875rem] font-bold uppercase tracking-[0.18em] text-rose-text">Important risk context</p>
            ...
            <a
              ...
              className="text-sm font-semibold text-rose-text underline decoration-rose-light underline-offset-4 hover:text-rose-text"
            >
      ...
      <section className="bg-rose-blush py-20 md:py-24" aria-labelledby="vacaville-microneedling-consult">
        <div className="mx-auto grid max-w-[1040px] gap-8 px-6 md:grid-cols-[1fr_auto] md:items-center md:px-8">
          <div>
            <p className="mb-3 text-[0.6875rem] font-bold uppercase tracking-[0.2em] text-rose-text">Online consultation booking</p>
            <h2 id="vacaville-microneedling-consult" className="mb-3 text-3xl font-medium tracking-[-0.035em] text-rose-text">
              Start with the Initial Microneedling Consult.
            </h2>
            <p className="max-w-[700px] text-ink/70">
              The live category currently lists the Initial Microneedling Consult. Select it to review details before choosing a professional or appointment.
            </p>
          </div>
          <Button disableHover href={BOOKING_HREF} data-cta="service-booking" className="rounded-full">
            Book Initial Microneedling Consult
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-microneedling-faq">
        <div className="mx-auto max-w-[900px] px-6 md:px-8">
          ...
          <h2 id="vacaville-microneedling-faq" className="mb-8 text-3xl font-medium tracking-[-0.035em] text-rose-text md:text-5xl">
