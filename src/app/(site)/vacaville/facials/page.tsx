...
export const metadata: Metadata = {
  ...
  description:
    "Compare current professional facial options at Rella Aesthetics in downtown Vacaville and book the verified Initial Skin Health Consult.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "Professional Facials in Vacaville | Rella Aesthetics",
    description:
      "A consult-first path to current facial options, individualized product planning, and clear next steps in downtown Vacaville.",
    url: CANONICAL,
    type: "website",
    images: [
      {
...
const facialOptions = [
  ...
  },
  {
    ...
    body: "A current Vacaville menu option. Ask how the exfoliation method, preparation, expected response, and aftercare fit your skin and recent treatments.",
  },
  {
    name: "Express Facial",
    body: "A separate current menu option for a more focused visit. Confirm the included steps and whether it matches what you want from the appointment.",
  },
  {
    name: "Acne Facial",
...
const faqs = [
  {
    ...
    answer:
      "Rella's current Vacaville menu includes an Initial Skin Health Consult, Microdermabrasion, Express Facial, Acne Facial, and Dermaplaning Facial. HydraFacial tiers are also available through their own booking path. Inventory can change, so confirm the selected service before treatment.",
  },
  {
...
export default function VacavilleFacialsPage() {
  return (
    <>
        ...
        <div className="mx-auto grid max-w-[1200px] items-center gap-12 px-6 md:px-8 lg:grid-cols-[1.04fr_0.96fr] lg:px-12">
          <div>
            ...
            <p className="mb-8 max-w-[650px] text-lg font-light leading-relaxed text-silver-dark md:text-xl">
              Compare current professional facial options around your skin, products, recent treatments, goals, and schedule—then start with the verified Initial Skin Health Consult.
            </p>
            ...
            <p className="mt-5 text-xs leading-6 text-silver">
              Opens Rella Vacaville&apos;s live Initial Skin Health Consult. A professional and appointment time are selected in the secure booking flow.
            </p>
          </div>
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-facial-options">
        <div className="mx-auto max-w-[1120px] px-6 md:px-8">
          <div className="mb-12 max-w-[810px]">
            ...
            <h2 id="vacaville-facial-options" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-ink md:text-5xl">
              Start with your skin. Then choose the service.
            </h2>
            <p className="text-lg font-light leading-relaxed text-silver">
              These paths are currently visible in Rella&apos;s Vacaville facial menu. The consult helps connect a service name to the products, steps, and aftercare that make sense for you.
            </p>
          </div>
      ...
      <section className="bg-ink py-20 text-white md:py-28" aria-labelledby="vacaville-facial-visit">
        <div className="mx-auto max-w-[1120px] px-6 md:px-8">
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-facial-booking">
        <div className="mx-auto grid max-w-[1040px] gap-8 px-6 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h2 id="vacaville-facial-booking" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-ink md:text-5xl">
              Begin at the Initial Skin Health Consult.
            </h2>
            <p className="text-lg font-light leading-relaxed text-silver">
              The verified booking path opens that exact Vacaville service and displays <strong className="font-medium text-ink">Select a professional</strong>. It does not choose a treatment or appointment for you.
            </p>
          </div>
      ...
      <section className="bg-rose-blush py-20 md:py-24" aria-labelledby="vacaville-facial-compare">
        <div className="mx-auto grid max-w-[1040px] gap-8 px-6 md:grid-cols-[1fr_auto] md:items-center md:px-8">
          <div>
            ...
            <h2 id="vacaville-facial-compare" className="mb-3 text-3xl font-medium tracking-[-0.035em] text-ink">
          ...
          <div className="flex flex-col gap-3">
            <Button href="/vacaville/hydrafacial" variant="ghost" className="rounded-full bg-white">Explore HydraFacial</Button>
      ...
      <section className="py-20 md:py-28" aria-labelledby="vacaville-facial-faq">
        <div className="mx-auto max-w-[900px] px-6 md:px-8">
          ...
          <h2 id="vacaville-facial-faq" className="mb-8 text-3xl font-medium tracking-[-0.035em] text-ink md:text-5xl">
      ...
      <section className="bg-rose-cta py-20 text-center text-white" aria-labelledby="vacaville-facial-next-step">
