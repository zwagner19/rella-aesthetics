...
import VacavilleFacialsPage, { metadata } from "./page";
...
describe("Vacaville facials local-acquisition page", () => {
  it("uses unique, exact index metadata", () => {
    expect(metadata.title).toBe("Facials in Vacaville | Skin Consult & Options");
    expect(metadata.alternates?.canonical).toBe(
      "https://experiencerella.com/vacaville/facials",
    );
  ...
  it("keeps visible FAQ and FAQ schema in exact sync", () => {
    ...
    expect(service.areaServed.name).toBe("Vacaville");
  });
