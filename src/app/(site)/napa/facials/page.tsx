...
export const metadata: Metadata = {
  ...
  description:
    "Compare the three facial options currently available for online booking at Rella Aesthetics in downtown Napa.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "Professional Facials in Napa | Rella Aesthetics",
    description:
      "A skin consult plus Signature and Deluxe HydraFacial booking options in downtown Napa.",
    url: CANONICAL,
    type: "website",
    images: [
      {
...
const facialOptions = [
  {
    ...
    body: "A 15-minute starting point to review your skin, current concerns, products, sensitivities, recent procedures, and goals before a plan is selected.",
  },
  {
    name: "Signature HydraFacial",
    body: "A 45-minute HydraFacial currently available in Napa's online facial category. Review the included steps and any relevant preparation or aftercare before treatment.",
  },
  {
    name: "Deluxe HydraFacial",
    body: "A 45-minute HydraFacial currently available in Napa's online facial category. Compare its included steps with Signature before selecting an appointment.",
  },
] as const;
...
const visitSteps = [
  ...
  {
    title: "Select",
    body: "Compare the three current online options and confirm the exact steps, products, enhancements, and total for the chosen service.",
  },
  {
    title: "Experience",
...
const faqs = [
  {
    ...
    answer:
      "Rella's current Napa online facial category lists an Initial Skin Health Consult, Signature HydraFacial, and Deluxe HydraFacial. Inventory can change, so confirm the selected service in the booking flow.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "HydraFacial is a branded multi-step service. Napa's online facial category currently lists Signature and Deluxe HydraFacial alongside the Initial Skin Health Consult. The team can explain the steps included in each option.",
  },
  {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid max-w-[1200px] items-center gap-12 px-6 md:px-8 lg:grid-cols-[1.04fr_0.96fr] lg:px-12">
          <div>
            ...
            <p className="mb-8 max-w-[650px] text-lg font-light leading-relaxed text-silver-dark md:text-xl">
              Compare the three facial options currently available online around your skin, recent treatments, goals, and schedule—then choose in Rella&apos;s booking flow.
            </p>
            ...
            <p className="mt-5 text-xs leading-6 text-ink/70">
              Opens Rella Napa&apos;s live facial category. No treatment, professional, or appointment is selected for you.
            </p>
          </div>
      ...
      <TrustStrip
        ...
        items={["Three online options", "15-minute skin consult", "45-minute HydraFacials", "Current total confirmed"]}
      />
      ...
      <section className="py-20 md:py-28" aria-labelledby="napa-facial-options">
        <div className="mx-auto max-w-[1120px] px-6 md:px-8">
          <div className="mb-12 max-w-[810px]">
            ...
            <h2 id="napa-facial-options" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-rose-text md:text-5xl">
              Start with your skin. Then choose the service.
            </h2>
            <p className="text-lg font-light leading-relaxed text-ink/70">
              The online category currently lists a skin consult plus Signature and Deluxe HydraFacial. Call Rella before booking if you need another facial option.
            </p>
          </div>
            ...
            {facialOptions.map((option, index) => (
              <article
                ...
                className={`border border-ink/12 p-7 md:p-8 ${
                  index === 0
                    ? "bg-rose text-ink md:col-span-2 lg:col-span-2"
      ...
      <section className="bg-rose py-20 text-ink md:py-28" aria-labelledby="napa-facial-visit">
        <div className="mx-auto max-w-[1120px] px-6 md:px-8">
      ...
      <section className="py-20 md:py-28" aria-labelledby="napa-facial-booking">
        <div className="mx-auto grid max-w-[1040px] gap-8 px-6 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h2 id="napa-facial-booking" className="mb-5 text-3xl font-medium tracking-[-0.04em] text-rose-text md:text-5xl">
              Choose a skin consult or HydraFacial.
            </h2>
            <p className="text-lg font-light leading-relaxed text-ink/70">
              The verified booking path opens Napa&apos;s facial category with the clinic selected. You choose the service, professional, and appointment in the secure booking flow.
            </p>
          </div>
      ...
      <section className="bg-rose-blush py-20 md:py-24" aria-labelledby="napa-facial-compare">
        <div className="mx-auto grid max-w-[1040px] gap-8 px-6 md:grid-cols-[1fr_auto] md:items-center md:px-8">
          <div>
            ...
            <h2 id="napa-facial-compare" className="mb-3 text-3xl font-medium tracking-[-0.035em] text-rose-text">
          ...
          <div className="flex flex-col gap-3">
            <Button href="/services/hydrafacial" variant="ghost" disableHover className="rounded-full bg-white">Explore HydraFacial</Button>
            <Link href="/services/laser-treatments" className="text-center text-sm font-semibold text-rose-text underline underline-offset-4">Compare laser options</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28" aria-labelledby="napa-facial-faq">
        <div className="mx-auto max-w-[900px] px-6 md:px-8">
          ...
          <h2 id="napa-facial-faq" className="mb-8 text-3xl font-medium tracking-[-0.035em] text-rose-text md:text-5xl">
            Napa facial FAQ
          </h2>
      ...
      <section className="bg-rose py-20 text-center text-ink" aria-labelledby="napa-facial-next-step">
        <div className="mx-auto max-w-[740px] px-6">
          ...
          <div className="flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Button disableHover href="tel:+17073582928" data-cta="phone" variant="ghost" className="!border-white !bg-white !text-rose-text">
              Call Rella
            </Button>
          </div>
