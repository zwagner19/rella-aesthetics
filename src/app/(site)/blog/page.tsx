          ...
          <div className="mt-20 border-t border-silver-pale pt-16">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              {educationPaths.map((path) => (
                ...
                >
                  <p className="mb-8 text-[0.625rem] font-bold uppercase tracking-[0.2em] text-rose-text">
                    {path.category}
                  </p>
                  <h2 className="mb-3 text-xl font-medium leading-snug text-rose-text">
                    {path.title}
                  </h2>
                  <p className="mb-6 flex-1 text-sm leading-relaxed text-ink/70">
                    {path.description}
                  </p>
                  <span className="text-sm font-medium text-rose-text transition-colors group-hover:text-ink">
