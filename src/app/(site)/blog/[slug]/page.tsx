    ...
    <>
      ...
      <section className="py-20 bg-rose-blush">
        <div className="mx-auto max-w-[1200px] px-6 md:px-8 lg:px-12">
          {post.categoryName && (
            <p className="font-bold text-[0.6875rem] tracking-[0.2em] uppercase text-rose-text mb-3">
              {post.categoryName}
            </p>
          )}
          <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl tracking-[0.04em] text-rose-text mb-4 max-w-[800px] leading-[1.2]">
            {post.title}
          </h1>
