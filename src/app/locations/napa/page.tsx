...
import { BOOKING_URL_NAPA } from "@/lib/booking-links";

export const metadata: Metadata = {
  title: "Napa Med Spa",
  description:
    "Visit Rella Aesthetics in downtown Napa — 1541 3rd St. Botox, fillers, laser treatments, weight loss, and more. Book your appointment today.",
};
      ...
      <section className="py-24 bg-rose-blush">
        <div className="mx-auto max-w-[1200px] px-6 md:px-8 lg:px-12">
          ...
          <p className="text-lg font-light text-silver max-w-[560px] leading-relaxed">
            Our wine country location in the heart of downtown Napa.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1200px] px-6 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
            <div>
              ...
              <div className="mt-8">
                <Button href={BOOKING_URL_NAPA}>Book at Napa</Button>
              </div>
            </div>
