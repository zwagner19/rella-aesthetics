...
export const additionalTeamMembers = [
  { name: "Devyn Pickett", image: "/images/team/devyn.jpg" },
  { name: "Paula", image: "/images/team/paula.jpg" },
  { name: "Ayano", image: "/images/team/ayano.jpg" },
  { name: "Natalie", image: "/images/team/natalie.jpg" },
  { name: "Ryan", image: "/images/team/ryan.jpg" },
] as const;
