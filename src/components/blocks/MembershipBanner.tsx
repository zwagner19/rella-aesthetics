...
export function MembershipBanner() {
  return (
    <section className="bg-white border-y border-silver-pale py-12">
      <div className="mx-auto max-w-[1200px] px-6 md:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <p className="text-eyebrow mb-2">VIP Membership</p>
            <h2 className="font-medium text-2xl md:text-3xl text-ink mb-2">
