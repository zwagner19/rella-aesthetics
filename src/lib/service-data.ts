...
export const servicePages: ServicePageData[] = [
  ...
  },
  {
    ...
    metaTitle: "GLP-1 Medical Weight Loss in Vacaville & Napa, CA",
    ...
    whatToExpect: {
      heading: "What to Expect",
      body: "The program begins with a medical qualification phone consultation with Zachary Wagner, DO, followed by the appropriate clinical evaluation and support.",
      steps: [
    ...
    pricing: {
      ...
      note: "The medical qualification phone consultation requires no card and does not guarantee treatment or a prescription.",
    },
    faq: [
