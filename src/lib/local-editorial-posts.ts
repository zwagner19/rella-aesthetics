...
export const LOCAL_EDITORIAL_POSTS: readonly LocalEditorialPost[] = [
  {
    ...
    coverImage: "/images/service-botox.jpg",
    ogImage: "/images/og-botox-cost-napa.png",
    coverAlt: "Botox and Dysport treatment at Rella Aesthetics",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Rella Aesthetics Napa is at 1541 3rd St, Napa, CA 94559, with street and garage parking within one block. The current Napa schedule is Wednesday through Saturday. Online booking is available at any time, even when the clinic is closed.",
