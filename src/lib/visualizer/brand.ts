/** Rella Aesthetics branding for the AI treatment visualizer (experiencerella.com). */

export const RELLA_BRAND = {
  name: "Rella Aesthetics",
  site: "experiencerella.com",
  siteUrl: "https://experiencerella.com",
  locations: "Vacaville & Napa, CA",
...
export const VISUALIZER_HERO_DESCRIPTION =
  "Upload a selfie and preview conservative, physician-led Botox & Dysport results on your own face — at Rella Aesthetics in Vacaville or Napa.";
